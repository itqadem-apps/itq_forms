...
from . import children_pb2 as children__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in children_pb2_grpc.py depends on'
...
def add_ChildServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'itq.users.v1.ChildService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('itq.users.v1.ChildService', rpc_method_handlers)
