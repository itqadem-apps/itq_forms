...
def enroll_user_in_assessment(request_user, survey_id, child=None, collection_id=None):
    ...
    with transaction.atomic():
        ...
        user_survey = UserSurvey.objects.create(
            ...
            cover_id=next((a.asset_id for a in survey.assets.all() if a.asset_type == "cover"), None),
            thumb_id=next((a.asset_id for a in survey.assets.all() if a.asset_type == "thumbnail"), None),
